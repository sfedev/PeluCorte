        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailContacto = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Peluquerias", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeluqueriaId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Peluqueros_Peluquerias_PeluqueriaId",
                        column: x => x.PeluqueriaId,
                        principalTable: "Peluquerias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citas_Peluquerias_PeluqueriaId",
                        column: x => x.PeluqueriaId,
                        principalTable: "Peluquerias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Citas_Peluqueros_PeluqueroId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Citas_PeluqueriaId_Fecha",
                table: "Citas",
                columns: new[] { "PeluqueriaId", "Fecha" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Peluquerias_Slug",
                table: "Peluquerias",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Peluqueros_PeluqueriaId",
                table: "Peluqueros",
                column: "PeluqueriaId");
        }
